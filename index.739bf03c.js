...
const showChampions = async ()=>{
    ...
    fetch(baseUrl + '13.18.1/data/es_ES/champion.json').then((response)=>{
        ...
        for (let champion of Object.values(data.data)){
            ...
            // Agregamos el campeon al grid
            showChampion(champion.name, image);
        }
    });
};

},{"./champion.js":"7JCCW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7JCCW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
